/*
 For node C which has Temperature sensor 
...
//7E 00 0D 00 01 00 13 A2 00 41 63 0C 3E 00 01 12 48    f7
 int b= 0x1A5 + temp_data;// + 0x01;// {
 int b1 = 0x1A6 + soil_data; //+ 0x02;
 int b2 = 0x1A7 + light_data; //+ 0x03;
 
// 7E 00 0D 00 01 00 13 A2 00 41 63 0C 3A 00 01 12 4C
 int c= 0x1A1 + temp_data ;//+ 0x01;
 int c1 = 0x1A2 + soil_data; // + 0x02;
 int c2 = 0x1A3 + light_data ; //+ 0x03;

//7E 00 0D 00 01 00 13 A2 00 41 63 0C 3F 

 int d= 0x1A6 + temp_data ;//+ 0x01;
 int d1 = 0x1A7 + soil_data; // + 0x02;
 int d2 = 0x1A8 + light_data ; //+ 0x03;
...
byte end1core[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3E,0x00,0x01,temp_data,checksumb};
byte end1guest1[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3E,0x00,0x02,soil_data,checksumb1};
byte end1guest2[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3E,0x00,0x03,light_data,checksumb2};

//-------------------------------------------------------------------Frames for node I --------------------------------------------------------------
 // 7E 00 0D 00 01 00 13 A2 00 41 63 0C 3A 00 01 12 4C
 byte end2core[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3A,0x00,0x01,temp_data,checksumc}; 
 byte end2guest1[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3A,0x00,0x02,soil_data,checksumc1};
 byte end2guest2[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3A,0x00,0x03,light_data,checksumc2}; 
 
//-------------------------------------------------------------------Frames for node J --------------------------------------------------------------
 // 7E 00 0F 10 01 00 13 A2 00 41 63 0C 49 FF FE 00 00 F3 50
 //7E 00 0D 00 01 00 13 A2 00 41 63 0C 3F 
 byte end3core[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3F,0x00,0x01,temp_data,checksumd}; 
 byte end3guest1[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3F,0x00,0x02,soil_data,checksumd1};
 byte end3guest2[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3F,0x00,0x03,light_data,checksumd2}; 
