/*
 For node M which has light intensity sensor 
...
//7E 00 0D 00 01 00 13 A2 00 41 63 0C 49 00 02 12 46    f7
 int b= 0x1B0 + temp_data;// + 0x01;// {
 int b1 = 0x1B1 + soil_data; //+ 0x02;
 int b2 = 0x1B2 + light_data; //+ 0x03;
 
// 7E 00 0D 00 01 00 13 A2 00 41 62 FF FE 00 01 12 49
 int c= 0x357 + temp_data ;//+ 0x01;
 int c1 = 0x358 + soil_data; // + 0x02;
 int c2 = 0x359 + light_data ; //+ 0x03;

//7E 00 0D 00 01 00 13 A2 00 41 63 0C 2B 00 01 12 3D

 int d= 0x192 + temp_data ;//+ 0x01;
 int d1 = 0x193 + soil_data; // + 0x02;
 int d2 = 0x194 + light_data ; //+ 0x03;
...
//-------------------------------------------------------------------Frames for node G --------------------------------------------------------------
 // 7E 00 0F 10 01 00 13 A2 00 41 63 0C 49 FF FE 00 00 F3 50
 //7E 00 0D 00 01 00 13 A2 00 41 63 0C 2B 00 01 12 3D
 byte end3core[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x2B,0x00,0x01,temp_data,checksumd}; 
 byte end3guest1[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x2B,0x00,0x02,soil_data,checksumd1};
 byte end3guest2[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x2B,0x00,0x03,light_data,checksumd2}; 
