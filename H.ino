/*
 For node H which has Temperature sensor 
...
//7E 00 0D 00 01 00 13 A2 00 41 63 0C 49 00 01 12 48    f7
 int b= 0x1B0 + temp_data;// + 0x01;// {
 int b1 = 0x1B1 + soil_data; //+ 0x02;
 int b2 = 0x1B2 + light_data; //+ 0x03;
 
// 7E 00 0D 00 01 00 13 A2 00 41 62 FF FE 00 01 12 4C
 int c= 0x1A3 + temp_data ;//+ 0x01;
 int c1 = 0x1A4 + soil_data; // + 0x02;
 int c2 = 0x1A5 + light_data ; //+ 0x03;
...
// ------------------------------------------------------------------ Frames for node N -------------------------------------------------------------
//7E 00 0D 00 01 00 13 A2 00 41 63 0C 3E 00 01 12 48
byte end1core[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x49,0x00,0x01,temp_data,checksumb};
byte end1guest1[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x49,0x00,0x02,soil_data,checksumb1};
byte end1guest2[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x49,0x00,0x03,light_data,checksumb2};

//-------------------------------------------------------------------Frames for node M --------------------------------------------------------------
 // 7E 00 0D 00 01 00 13 A2 00 41 63 0C 3C 00 01 12 4C
 byte end2core[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3C,0x00,0x01,temp_data,checksumc}; 
 byte end2guest1[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3C,0x00,0x02,soil_data,checksumc1};
 byte end2guest2[] = {0x7E,0x00,0x0D,0x00,0x01,0x00,0x13,0xA2,0x00,0x41,0x63,0x0C,0x3C,0x00,0x03,light_data,checksumc2}; 
